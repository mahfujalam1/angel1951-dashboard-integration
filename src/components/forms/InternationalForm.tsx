...
export default function InternationalForm() {
  ...
  const disabledInputClass = "w-full border-none rounded-md px-3 py-2.5 text-sm text-slate-400 bg-slate-50 cursor-not-allowed";
      ...
      <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2">
            ...
            />
            <div className="flex items-center justify-center px-3 bg-slate-100/50 border-none rounded-md text-slate-500 text-sm font-medium min-w-[60px]">
