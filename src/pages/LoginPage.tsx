  ...
  return (
    <div className="min-h-screen flex" style={{ background: "#f8fafc" }}>
      ...
      >
        ...
        />
        <div
          className="absolute top-1/2 right-10 w-48 h-48 rounded-full opacity-5"
          style={{ background: "white" }}
        />
        ...
        <div className="relative z-10 space-y-6">
          <div>
            ...
            <p className="mt-3 text-blue-200 text-base leading-relaxed">
              Track shipments, manage hubs, and streamline your delivery
        ...
        <p className="text-blue-300 text-xs relative z-10">
          © 2026 Buan Logistics. All rights reserved.
        </p>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          >
            ...
            >
              <Input.Password
                prefix={
                  <Lock size={14} className="text-slate-400 cursor-pointer" />
                }
                placeholder="••••••••"
                style={{ height: 44, borderRadius: 10 }}
                iconRender={(visible) =>
