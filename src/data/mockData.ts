...
export const hubs: Hub[] = [
  { id: '1', hubNameId: 'Dubai Hub', hubLocation: 'Kerala, India', contactNumber: '+1 (470) 918 8533', status: 'Active', throughput: '120 Rcv / 85 Dep', manager: 'John Lim', email: 'dubai@Buan Logistics.com', address: '55 Hillview Ave, Dubai UAE 669950', openDays: ['Mon','Tue','Wed','Thu','Fri'], hours: '09:00 AM - 06:00 PM', staffCount: 12 },
  { id: '2', hubNameId: 'London Hub', hubLocation: 'Andra Pradesh', contactNumber: '+1 (907) 555-0101', status: 'Active', throughput: '98 Rcv / 72 Dep', manager: 'Sarah Jones', email: 'london@Buan Logistics.com', address: '12 Baker Street, London W1U 3BH', openDays: ['Mon','Tue','Wed','Thu','Fri','Sat'], hours: '08:00 AM - 07:00 PM', staffCount: 9 },
  { id: '3', hubNameId: 'NY Hub', hubLocation: 'Karnataka', contactNumber: '+1 (470) 918 6544', status: 'Active', throughput: '145 Rcv / 110 Dep', manager: 'Mike Davis', email: 'ny@Buan Logistics.com', address: '350 Fifth Ave, New York NY 10118', openDays: ['Mon','Tue','Wed','Thu','Fri'], hours: '07:00 AM - 08:00 PM', staffCount: 18 },
  { id: '4', hubNameId: 'Singapore Hub', hubLocation: 'Tamil Nadu', contactNumber: '+1 (704) 555-0127', status: 'Active', throughput: '88 Rcv / 65 Dep', manager: 'Li Wei', email: 'sg@Buan Logistics.com', address: '1 Marina Blvd, Singapore 018989', openDays: ['Mon','Tue','Wed','Thu','Fri','Sat'], hours: '08:00 AM - 06:00 PM', staffCount: 7 },
  { id: '5', hubNameId: 'Tokyo Hub', hubLocation: 'Karnataka', contactNumber: '+1 (480) 555-2501', status: 'Active', throughput: '76 Rcv / 55 Dep', manager: 'Yuki Tanaka', email: 'tokyo@Buan Logistics.com', address: '2-1 Marunouchi, Tokyo 100-0005', openDays: ['Mon','Tue','Wed','Thu','Fri'], hours: '09:00 AM - 05:00 PM', staffCount: 6 },
  { id: '6', hubNameId: 'KL Hub', hubLocation: 'Andra Pradesh', contactNumber: '+1 (207) 555-1103', status: 'Active', throughput: '65 Rcv / 48 Dep', manager: 'Ahmad Razak', email: 'kl@Buan Logistics.com', address: 'Jalan Bukit Bintang, Kuala Lumpur 55100', openDays: ['Mon','Tue','Wed','Thu','Fri','Sat'], hours: '09:00 AM - 06:00 PM', staffCount: 5 },
  { id: '7', hubNameId: 'Sydney Hub', hubLocation: 'Tamil Nadu', contactNumber: '+1 (480) 555-0103', status: 'Active', throughput: '92 Rcv / 78 Dep', manager: 'James Wong', email: 'sydney@Buan Logistics.com', address: '1 Macquarie St, Sydney NSW 2000', openDays: ['Mon','Tue','Wed','Thu','Fri'], hours: '08:00 AM - 05:00 PM', staffCount: 8 },
  { id: '8', hubNameId: 'Toronto Hub', hubLocation: 'Karnataka', contactNumber: '+1 (203) 555-2322', status: 'Inactive', throughput: '0 Rcv / 0 Dep', manager: 'Emily Clark', email: 'toronto@Buan Logistics.com', address: '100 Queen St W, Toronto ON M5H 2N2', openDays: ['Mon','Tue','Wed','Thu'], hours: '09:00 AM - 05:00 PM', staffCount: 4 },
  { id: '9', hubNameId: 'Paris Hub', hubLocation: 'Tamil Nadu', contactNumber: '+1 (470) 918 6577', status: 'Inactive', throughput: '0 Rcv / 0 Dep', manager: 'Pierre Dupont', email: 'paris@Buan Logistics.com', address: '29 Rue La Boetie, Paris 75008', openDays: ['Mon','Tue','Wed','Thu','Fri'], hours: '09:00 AM - 06:00 PM', staffCount: 3 },
  { id: '10', hubNameId: 'Berlin Hub', hubLocation: 'Karnataka', contactNumber: '+1 (225) 555-2223', status: 'Inactive', throughput: '0 Rcv / 0 Dep', manager: 'Hans Mueller', email: 'berlin@Buan Logistics.com', address: 'Unter den Linden 77, 10117 Berlin', openDays: ['Mon','Tue','Wed','Thu','Fri'], hours: '09:00 AM - 05:00 PM', staffCount: 4 },
];

export const staffList: Staff[] = [
  { id: '1', name: 'Ahmed Khan', role: 'Delivery', hub: 'Dubai Hub', status: 'Active', contact: '+34594 65 6418', avatar: 'https://i.pravatar.cc/40?img=21', email: 'ahmed@Buan Logistics.com', joinDate: 'Jan 5, 2024', deliveries: 234 },
  { id: '2', name: 'Rashid Ali', role: 'Delivery', hub: 'Dubai Hub', status: 'Active', contact: '+34594 65 6419', avatar: 'https://i.pravatar.cc/40?img=22', email: 'rashid@Buan Logistics.com', joinDate: 'Feb 12, 2024', deliveries: 189 },
  { id: '3', name: 'Carlos Ruiz', role: 'Delivery', hub: 'LA Hub', status: 'Inactive', contact: '+34594 65 6420', avatar: 'https://i.pravatar.cc/40?img=23', email: 'carlos@Buan Logistics.com', joinDate: 'Mar 20, 2024', deliveries: 97 },
  { id: '4', name: 'Mike Davis', role: 'Manager', hub: 'NY Hub', status: 'Active', contact: '+34594 65 6421', avatar: 'https://i.pravatar.cc/40?img=24', email: 'mike@Buan Logistics.com', joinDate: 'Apr 3, 2024', deliveries: 0 },
  { id: '5', name: 'Li Wei', role: 'Delivery', hub: 'Singapore Hub', status: 'Busy', contact: '+34594 65 6422', avatar: 'https://i.pravatar.cc/40?img=25', email: 'liwei@Buan Logistics.com', joinDate: 'May 15, 2024', deliveries: 312 },
  { id: '6', name: 'James Wong', role: 'Warehouse', hub: 'Sydney Hub', status: 'Active', contact: '+34594 65 6423', avatar: 'https://i.pravatar.cc/40?img=26', email: 'james@Buan Logistics.com', joinDate: 'Jun 22, 2024', deliveries: 0 },
  { id: '7', name: 'Emily Clark', role: 'Manager', hub: 'Toronto Hub', status: 'Active', contact: '+34594 65 6424', avatar: 'https://i.pravatar.cc/40?img=27', email: 'emily@Buan Logistics.com', joinDate: 'Jul 8, 2024', deliveries: 0 },
  { id: '8', name: 'Yuki Tanaka', role: 'Delivery', hub: 'Tokyo Hub', status: 'Active', contact: '+34594 65 6425', avatar: 'https://i.pravatar.cc/40?img=28', email: 'yuki@Buan Logistics.com', joinDate: 'Aug 19, 2024', deliveries: 156 },
];
